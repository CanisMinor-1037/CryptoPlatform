  ...
  <div class="upload">
    <el-row :gutter="5">
      ...
      >
        ...
        <el-button size="small" type="primary" @click="databaseDialogVisible = true">数据库信息</el-button>
        <el-button
      ...
      <el-dialog title="输入数据库信息" :visible.sync="databaseDialogVisible" width="35%">
        <el-form :model="database">
          <el-form-item label="数据库名">
            <el-input v-model="database.name"></el-input>
          </el-form-item>
          <el-form-item label="数据库地址">
            <el-input v-model="database.url"></el-input>
          </el-form-item>
          ...
          <el-form-item>
            <el-button type="primary" @click ="databaseDialogVisible=false">确定</el-button>
          </el-form-item>
        </el-form>
      </el-dialog>
...
export default {
  ...
  methods: {
    ...
    handleUpload(){
      ...
      formData.append('name',this.database.name);
      ...
      formData.append('password',this.database.password);
        this.$http.post("/api/confirmation/uploadDbAsset", formData, {  
        headers: {  
