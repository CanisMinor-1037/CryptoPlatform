  ...
  <div class="myApplicationHistroy">  
    ...
    <div class="resultsList">
        ...
        <template slot="header" slot-scope="scope">
          <el-dropdown trigger="click">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item @click.native="getStatus(5)">成功</el-dropdown-item>
              <el-dropdown-item @click.native="getStatus(6)">失败</el-dropdown-item>
            </el-dropdown-menu>
            </el-dropdown>
        </template>
        <template slot-scope="scope">
            <el-tag
              :class="{
                ...
                step5:scope.row.status === 5,
                step6:scope.row.status === 6
              }"
              disable-transitions
              effect="dark"
              size="small"
      ...
      <!--<el-table-column
        ...
        >
        <template slot-scope="scope">
<el-progress :text-inside="true" :stroke-width="20" :percentage="getProcess(scope.row.status)" 
  ...
  methods: {
    ...
    async getData() {
      const res = await this.$http.get(
        "/api/order/databaseApplyHistory"
      );
